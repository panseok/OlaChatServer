...
public class DatabaseConnection {
    ...
    private static int MySQLMINCONNECTION = 1;
    private static int MySQLMAXCONNECTION = 2100000000;

    public static final String MYSQLSCHEMA = "olachatdb";
    public static final String MySQLUSER = "root";
    public static final String MySQLPASS = "rt0909817";
    public static final String MySQLURL = "jdbc:mysql://localhost:3306/" + MYSQLSCHEMA + "?autoReconnect=true&characterEncoding=utf8&maxReconnects=1";
    ...
    public synchronized static void init() {
        ...
        System.out.println("DatabaseServer On");
    }
    ...
    public static void closeObject(Connection con) {
        try {
            ...
            Logger.getLogger("MYSQL").log(Level.SEVERE, null, ex);
        }
    }
